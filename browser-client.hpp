...
#ifdef _WIN32
#include "interaction/interaction_main_win.h"
#else
...
public:
	...
	//PRISM/Xiewei/20221226/obs upgrade: cef interaction
	virtual bool OnCursorChange(CefRefPtr<CefBrowser> browser, CefCursorHandle cursor, cef_cursor_type_t type,
