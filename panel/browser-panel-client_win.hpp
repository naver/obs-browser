...
public:
	//PRISM/Zhangdewen/20230117/#/libbrowser
	inline QCefBrowserClient(QCefWidgetImpl *impl) : QCefBrowserClient(impl, impl) {}
	//PRISM/Zhangdewen/20230117/#/libbrowser
	inline QCefBrowserClient(QCefWidgetImpl *impl, QCefWidgetImpl *checkImpl) : m_impl(impl), m_checkImpl(checkImpl)
	{
	}
