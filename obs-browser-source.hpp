...
#if defined(_WIN32)
#include "interaction/interaction_delegate.h"
#include "interaction/gdi_plus_helper.h"
#else
...
struct BrowserSource {
	...
	//PRISM/Xiewei/20221226/obs upgrade: cef interaction
	std::unique_ptr<InteractionDelegate> interaction_delegate;
	...
	void dispatchJs(const char *eventName, const char *jsonData);
